...
const Checkbox = ({ children, onChange, checked = false, disabled = false, heightInGridUnits = 6 }: CheckboxProps): JSX.Element => {
  const iconType = disabled ? (checked ? disabledCheckedIcon : disabledIcon) : checked ? checkedCheckboxIcon : checkboxIcon;
