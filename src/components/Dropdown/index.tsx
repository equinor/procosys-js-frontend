...
const Dropdown: React.FC<DropdownProps> = ({ disabled = false, text = '', Icon, children, onFilter, label, variant, meta, maxHeight = '80vh', keepOpen }: DropdownProps): JSX.Element => {
        ...
        >
          ...
          {children &&
            ...
            React.Children.map(children, (item, index) => {
              return (
                <DropdownItem key={index} role="option" onClick={keepOpen ? undefined : toggleDropdown} tabIndex={0}>
                  {item}
                </DropdownItem>
              );
            })}
