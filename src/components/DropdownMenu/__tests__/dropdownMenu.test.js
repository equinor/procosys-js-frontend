...
describe("Dropdown should handle events", async () => {

    it('Hides dropdown when clicking outside of element', async () => {
        ...
        await wait(() => expect(queryByText(items[0].text)).toBeNull());
