import { account_circle, add, add_circle_filled, alarm_on, arrow_back, arrow_down, arrow_up, attach_file, bookmark_collection, calendar_today, category, checkbox, checkbox_outline, chevron_down, chevron_right, chevron_up, close, copy, delete_forever, delete_to_trash, done, done_all, edit, edit_text, error_filled, fast_forward, filter_list, info_circle, lock, microsoft_excel, microsoft_outlook, more_horizontal, more_verticle, notifications, person, place, play, pressure, print, restore_from_trash, search, star_filled, star_outlined, verticle_split, warning_filled, warning_outlined, world } from '@equinor/eds-icons';
