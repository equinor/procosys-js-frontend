...
export function TablePagination<T extends Record<string, unknown>>({ instance }: PropsWithChildren<{ instance: TableInstance<T> }>): ReactElement | null {
  ...
  return rowCount ? (
    <MuiTablePagination component="div" rowsPerPageOptions={rowsPerPageOptions} count={rowCount} rowsPerPage={pageSize} page={pageIndex} onPageChange={handleChangePage} onRowsPerPageChange={onChangeRowsPerPage} />
  ) : null;
}
