...
import TreeView, { TreeViewProps, TreeViewNode } from '@procosys/components/TreeView';
...
const getRegisterNodes = async (): Promise<TreeViewNode[]> => {
    const children: TreeViewNode[] = [{ id: 'Child1', name: 'Child1', getChildren: getRegisterNodes2 }, { id: 'Child2', name: 'Child2' }];
    return children;
};

const getRegisterNodes2 = async (): Promise<TreeViewNode[]> => {
    const children: TreeViewNode[] = [{ id: 'GrandChild1', name: 'GrandChild1' }, { id: 'GrandChild2', name: 'GrandChild2' }];
    return children;
};
...
export const Default: Story<TreeViewProps> = (args: JSX.IntrinsicAttributes & TreeViewProps & { children?: React.ReactNode; }) => {
