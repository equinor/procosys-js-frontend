...
const withAccessControl =
  (WrappedComponent: () => JSX.Element, requiredPermissions: string[] = [], featureFlags: string[] = []): React.ComponentType<any> =>
  (props: any): ReactElement => {
    ...
    useEffect(() => {
      if (featureFlags.every((item) => window.FEATURE_FLAGS[item] || false)) {
