...
class InvitationForPunchOutApiClient extends ApiClient {
   ...
   */
  async getIPOs(projectName: string | null, page: number, pageSize: number, orderBy: string | null, orderDirection: string | null, filter: IPOFilter, setRequestCanceller?: RequestCanceler): Promise<IPOsResponse> {
  ...
  async getCommPkgsAsync(projectName: string, startWith: string, pageSize?: number, currentPage?: number, setRequestCanceller?: RequestCanceler): Promise<CommPkgPagingResponse> {
    ...
    if (projectName !== 'All projects') {
      settings['params']['projectName'] = projectName;
    }
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getIPO(id: number, setRequestCanceller?: RequestCanceler): Promise<InvitationResponse> {
    ...
    try {
      ...
      if (error.response.data) {
        ...
        if (errorResponse.errors) {
          throw new Error('Error: ' + Object.values(errorResponse.errors).flat().join('\n'));
        }
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async updateIpoParticipants(ipoId: number, participants: ParticipantDto[], setRequestCanceller?: RequestCanceler): Promise<number> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getComments(id: number, setRequestCanceller?: RequestCanceler): Promise<CommentResponse[]> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async addComment(id: number, comment: string, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Invitations/${id}/Comments`;
    const settings: AxiosRequestConfig = {};
    this.setupRequestCanceler(settings, setRequestCanceller);
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getHistory(id: number, setRequestCanceller?: RequestCanceler): Promise<HistoryResponse[]> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getAttachments(id: number, setRequestCanceller?: RequestCanceler): Promise<AttachmentResponse[]> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getAttachment(id: number, attachmentId: number, setRequestCanceller?: RequestCanceler): Promise<AttachmentResponse> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async deleteAttachment(id: number, attachmentId: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<AttachmentResponse[]> {
    const endpoint = `/Invitations/${id}/Attachments/${attachmentId}`;
    const settings: AxiosRequestConfig = {};
    this.setupRequestCanceler(settings, setRequestCanceller);
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async uploadAttachment(id: number, file: File, overwriteIfExists: boolean, setRequestCanceller?: RequestCanceler): Promise<number> {
    const endpoint = `/Invitations/${id}/Attachments`;
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async completePunchOut(id: number, completeDetails: CompleteAcceptIPODto, setRequestCanceller?: RequestCanceler): Promise<string> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async acceptPunchOut(id: number, acceptDetails: CompleteAcceptIPODto, setRequestCanceller?: RequestCanceler): Promise<PersonResponse[]> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async unsignPunchOut(id: number, participantId: number, participantRowVersion: string, setRequestCanceller?: RequestCanceler): Promise<PersonResponse[]> {
  ...
  async cancelPunchOut(id: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
    ...
    this.setupRequestCanceler(settings, setRequestCanceller);
    try {
      const result = await this.client.put(endpoint, { rowVersion: rowVersion }, settings);
      return result.data;
    } catch (error) {
      throw new IpoApiError(error as AxiosError);
    }
  ...
  /**
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
  async updateAttendedStatus(id: number, participantDetails: AttendedStatusDto, setRequestCanceller?: RequestCanceler): Promise<void> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async updateNotes(id: number, participantDetails: NotesDto, setRequestCanceller?: RequestCanceler): Promise<void> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async deletePunchOut(id: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getSavedIPOFilters(projectName: string | null, setRequestCanceller?: RequestCanceler): Promise<SavedIPOFilterResponse[]> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async addSavedIPOFilter(projectName: string | null, title: string, defaultFilter: boolean, criteria: string, setRequestCanceller?: RequestCanceler): Promise<void> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async exportInvitationsToExcel(projectName: string | null, sortProperty: string | null, sortDirection: string | null, iPOFilter: IPOFilter, setRequestCanceller?: RequestCanceler): Promise<BlobPart> {
