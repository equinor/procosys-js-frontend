...
const SelectScope = ({ type, selectedCommPkgScope, setSelectedCommPkgScope, selectedMcPkgScope, setSelectedMcPkgScope, commPkgNo, projectName, isDisabled }: SelectScopeProps): JSX.Element => {
          ...
          <SelectComponent>
            <Header>
              {currentCommPkg != null && commPkgNo == null && (
                <Button id="backButton" onClick={(): void => setCurrentCommPkg(null)} variant="ghost_icon">
            ...
            {currentCommPkg != null && (commPkgNo == null || (commPkgNo != null && type == 'DP')) && (
              <McPkgTable ref={mcPkgRef} selectedMcPkgScope={selectedMcPkgScope} setSelectedMcPkgScope={setSelectedMcPkgScope} projectName={projectName} commPkgNo={currentCommPkg} />
            )}
          </SelectComponent>
          <Divider />
        </>
