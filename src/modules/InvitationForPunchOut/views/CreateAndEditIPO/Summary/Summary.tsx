...
import { Container, FormContainer, Section, Subsection, TableSection, Column, LocationDetails } from './Summary.style';
...
const Summary = ({ generalInfo, mcPkgScope, commPkgScope, participants, attachments }: SummaryProps): JSX.Element => {
  ...
  const getParticipants = (participant: Participant, index: number): JSX.Element => {
    return (
      <Row key={index}>
        ...
        {participant.externalEmail && <Cell>{participant.externalEmail.email}</Cell>}
      </Row>
    );
  };
  ...
  const attachmentList = attachments
    ...
    .map((attachment, index) => {
      ...
      return (
        <Row key={index}>
          <Cell>
            <EdsIcon name={getFileTypeIconName(attachment.fileName)} />
          </Cell>
          <Cell>
          ...
          <Section>
            ...
            <div className="timeContainer">
              <Subsection>
                ...
                <Typography variant="body_long">{getFormattedDate(generalInfo.date)}</Typography>
              </Subsection>
              <Subsection>
        ...
        <Column>
          <TableSection>
            ...
            <Table>
              ...
              <Body>{participants.map((participant, i) => getParticipants(participant, i))}</Body>
            </Table>
          </TableSection>
