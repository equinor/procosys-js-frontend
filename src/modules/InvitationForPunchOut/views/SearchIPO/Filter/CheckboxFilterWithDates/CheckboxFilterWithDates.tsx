import { CheckboxFilterValue, dateFilterParamType, filterParamType } from '../InvitationsFilter';
...
const CheckboxFilterWithDates = ({ title, filterValues = [], filterParam, itemsChecked, dateFields, dateValues, onDateChange, onCheckboxFilterChange, icon }: CheckboxFilterWithDatesProps): JSX.Element => {
