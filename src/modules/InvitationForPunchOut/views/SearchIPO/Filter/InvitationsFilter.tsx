...
export type dateFilterParamType = 'punchOutDateFromUtc' | 'punchOutDateToUtc' | 'lastChangedAtFromUtc' | 'lastChangedAtToUtc';
    ...
    <Container>
      <Header filterActive={filterActive}>
        ...
        <div style={{ display: 'flex' }}>
          ...
          >
            {isExporting ? <Progress.Circular size={16} color="primary" /> : ExcelIcon}
          </Button>
          <Button
            variant="ghost"
      ...
      <CheckboxFilterWithDates
        ...
        dateValues={[localFilter.punchOutDateFromUtc, localFilter.punchOutDateToUtc]}
        onDateChange={onDateChange}
        onCheckboxFilterChange={onCheckboxFilterChange}
        itemsChecked={[...filter.punchOutDates, filter.punchOutDateFromUtc, filter.punchOutDateToUtc]}
        icon={'alarm_on'}
      />
      <CheckboxFilterWithDates
        ...
        dateValues={[localFilter.lastChangedAtFromUtc, localFilter.lastChangedAtToUtc]}
        onDateChange={onDateChange}
        onCheckboxFilterChange={onCheckboxFilterChange}
        itemsChecked={[...filter.ipoStatuses, filter.lastChangedAtFromUtc, filter.lastChangedAtToUtc]}
        icon={'world'}
      />
