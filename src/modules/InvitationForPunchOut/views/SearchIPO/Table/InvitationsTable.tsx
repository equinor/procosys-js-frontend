  ...
  const tableColumns = [
    ...
    },
    {
      ...
      accessor: (d: IPO): string | undefined => {
        if (d.status == IpoStatusEnum.SCOPEHANDEDOVER) return 'Scope handed over';
    ...
    },
    {
      ...
      Cell: (rowData: TableOptions<IPO>): JSX.Element => {
        return <Typography>{getFormattedDate(rowData.row.values.createdAtUtc)}</Typography>;
      },
    },
    {
      Header: 'Punch-out',
      ...
      Cell: (rowData: TableOptions<IPO>): JSX.Element => {
        return <Typography>{getFormattedDate(rowData.row.values.punchOutDateUtc)}</Typography>;
      },
    },
    {
      Header: 'Completed',
      ...
      Cell: (rowData: TableOptions<IPO>): JSX.Element => {
        return <Typography>{rowData.row.values.completedAtUtc ? getFormattedDate(rowData.row.values.completedAtUtc) : ''}</Typography>;
      },
    },
    {
      Header: 'Accepted',
      ...
      Cell: (rowData: TableOptions<IPO>): JSX.Element => {
        return <Typography>{rowData.row.values.acceptedAtUtc ? getFormattedDate(rowData.row.values.acceptedAtUtc) : ''}</Typography>;
      },
    },
    {
