        ...
        <Container>
            <Table
                ...
                columns={[
                    ...
                    { title: 'Comm pkg', render: (rowData: IPO): JSX.Element => getCommPkgColumn(rowData.commPkgs), cellStyle: { minWidth: '220px', maxWidth: '220px' } }, 
                    { title: 'MC pkg', render: (rowData: IPO): JSX.Element => getMcPkgColumn(rowData.mcPkgs), cellStyle: { minWidth: '220px', maxWidth: '220px' } },
