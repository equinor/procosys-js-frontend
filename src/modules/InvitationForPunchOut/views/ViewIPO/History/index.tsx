      ...
      {loading ? (
        ...
        <FormContainer>
          <HistoryTable>
            <Head>
              <Row>
                <Cell as="th" scope="col" style={{ verticalAlign: 'middle' }} width="160px">
                  Date
                </Cell>
                <Cell as="th" scope="col" style={{ verticalAlign: 'middle' }} width="90px">
                  Changed by
                </Cell>
              ...
              {history && history.length > 0 ? (
                history.map((historyItem) => (
                  <Row key={historyItem.id}>
                    ...
                    >
                      <Typography variant="body_short">{getFormattedDateAndTime(new Date(historyItem.createdAtUtc))}</Typography>
                    </Cell>
                    <Cell
                      as="td"
                      style={{
                    ...
                    >
                      <Typography variant="body_short">{`${historyItem.createdBy.userName}`}</Typography>
                    </Cell>
                    <Cell
                      as="td"
                      style={{
                ...
                <Row>
                  ...
                  >
                    <Typography style={{ textAlign: 'center' }} variant="body_short">
