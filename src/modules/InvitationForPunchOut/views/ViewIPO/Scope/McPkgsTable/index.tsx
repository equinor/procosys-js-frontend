          ...
          {mcPkgScope.length > 0 ? (
            mcPkgScope.map((mcPkg: McPkgScope, index: number) => (
              <Row key={index} as="tr">
                ...
                >
                  <Typography href={getMcPkgUrl(mcPkg.mcPkgNo)} variant="body_short" link>
                    {mcPkg.mcPkgNo}
                  </Typography>
                </Cell>
                <Cell as="td" style={{ verticalAlign: 'middle' }}>
                  <Typography variant="body_short">{mcPkg.description}</Typography>
                </Cell>
                <Cell
                  as="td"
                  style={{
                ...
                >
                  <Typography href={getCommPkgUrl(mcPkg.commPkgNo)} variant="body_short" link>
                    {mcPkg.commPkgNo}
                  </Typography>
                </Cell>
              </Row>
