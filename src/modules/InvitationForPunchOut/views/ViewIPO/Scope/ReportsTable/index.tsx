      ...
      <CustomTable>
        ...
        <Body>
          <Row as="tr">
            ...
            >
              <Typography href={getReportUrl(ReportIdEnum.MC32D)} variant="body_short" link>
                MC32D
              </Typography>
            </Cell>
            <Cell as="td" style={{ verticalAlign: 'middle' }}>
              <Typography variant="body_short">MC Scope</Typography>
            </Cell>
            <Cell
              as="td"
              style={{
          ...
          <Row as="tr">
            ...
            >
              <Typography href={getReportUrl(ReportIdEnum.MC84)} variant="body_short" link>
                MC84
              </Typography>
            </Cell>
            <Cell as="td" style={{ verticalAlign: 'middle' }}>
              <Typography variant="body_short">Punch List</Typography>
            </Cell>
            <Cell
              as="td"
              style={{
          ...
          <Row as="tr">
            ...
            >
              <Typography href={getReportUrl(ReportIdEnum.CDP06)} variant="body_short" link>
                CDP06
              </Typography>
            </Cell>
            <Cell as="td" style={{ verticalAlign: 'middle' }}>
              <Typography variant="body_short">Concession Deviation Permit</Typography>
            </Cell>
            <Cell
              as="td"
              style={{
