...
describe('<Scope />', () => {
    ...
    it('Renders mc pkg scope', async () => {
        const { queryByText } = renderWithTheme(<Scope commPkgScope={[]} mcPkgScope={mcPkgScope} />);
    ...
    it('Renders both mc and comm pkg scope', async () => {
        const { queryByText } = renderWithTheme(<Scope commPkgScope={commPkgScope} mcPkgScope={mcPkgScope} />);
