...
const TagFunction = (props: TagFunctionProps): JSX.Element => {
  ...
  return (
    <Container>
      <Breadcrumbs>
        Library / Tag functions / {tagFunctionData.registerCode}, {tagFunctionData.registerDescription} / {tagFunctionData.code}, {tagFunctionData.description}
      </Breadcrumbs>
      <DetailsSection>
        ...
        <InformationContainer>
          <div className="inputRow">
            <TextField id="inp_register" value={`${tagFunctionData.registerCode}, ${tagFunctionData.registerDescription}`} label="Register" disabled />
          </div>
          <div className="inputRow">
      ...
      <Section>
        <TabBar>
          ...
          <TabBarFiller>{/* Just fills out the empty space */}</TabBarFiller>
        </TabBar>
        <Section>
