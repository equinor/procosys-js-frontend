...
class PreservationApiClient extends ApiClient {
  constructor(authService: IAuthService) {
    super(authService, window.PRESERVATION_API_SCOPE, window.PRESERVATION_API_URL);
  ...
  async updateTagStep(tagDtos: StepUpdateTagDto[], stepId: number, setRequestCanceller?: RequestCanceler): Promise<string> {
   ...
   * @throws PreservationApiError
   */
  async addTagsToScopeByAutoscoping(listOfTagNo: string[], stepId: number, projectName: string, remark?: string | null, storageArea?: string | null, setRequestCanceller?: RequestCanceler): Promise<void> {
  ...
  async getPreservedTags(
    ...
    try {
      const result = await this.client.get<PreservedTagResponse>(endpoint, settings);
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async exportTagsToExcel(projectName: string, sortProperty: string | null, sortDirection: string | null, tagFilter: TagListFilter, setRequestCanceller?: RequestCanceler): Promise<BlobPart> {
   ...
   * @param setRequestCanceller Returns a function that can be called to cancel the request
   */
  async getJourneys(includeVoided: boolean, setRequestCanceller?: RequestCanceler, projectName?: string): Promise<JourneyResponse[]> {
   ...
   * Update journey
   */
  async updateJourney(journeyId: number, title: string, rowVersion: string, name?: string, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Journeys/${journeyId}`;
    const settings: AxiosRequestConfig = {};
    this.setupRequestCanceler(settings, setRequestCanceller);
  ...
  async deleteJourneyStep(journeyId: number, stepId: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
    ...
    try {
      await this.client.delete(endpoint, settings);
    } catch (error) {
      throw new PreservationApiError(error);
    }
  }
   ...
   */
  async getTagsForMigration(projectName: string, setRequestCanceller?: RequestCanceler): Promise<TagMigrationResponse[]> {
    ...
    try {
      const result = await this.client.get<TagMigrationResponse[]>(endpoint, settings);
   ...
   */
  async getTagsByTagFunctionForAddPreservationScope(projectName: string, tagFunctionCode?: string, registerCode?: string, setRequestCanceller?: RequestCanceler): Promise<TagSearchResponse[]> {
  ...
  async recordAttachmentOnTagRequirement(tagId: number, requirementId: number, fieldId: number, file: File, setRequestCanceller?: RequestCanceler): Promise<void> {
  ...
  async removeAttachmentOnTagRequirement(tagId: number, requirementId: number, fieldId: number, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Tags/${tagId}/Requirements/${requirementId}/Attachment/${fieldId}`;
    const settings: AxiosRequestConfig = {};
    this.setupRequestCanceler(settings, setRequestCanceller);
    try {
  ...
  async getDownloadUrlForAttachmentOnTagRequirement(tagId: number, requirementId: number, fieldId: number, setRequestCanceller?: RequestCanceler): Promise<string> {
    const endpoint = `/Tags/${tagId}/Requirements/${requirementId}/Attachment/${fieldId}`;
    const settings: AxiosRequestConfig = {
      params: {
        redirect: false,
  ...
  async getDownloadUrlForAttachmentOnPreservationRecord(tagId: number, tagRequirementId: number, preservationRecordGuid: string, setRequestCanceller?: RequestCanceler): Promise<string> {
   ...
   */
  async addRequirementDefinition(
    requirementTypeId: number,
    sortKey: number,
    usage: string,
    title: string,
    defaultIntervalWeeks: number,
    fields: FieldsFormInput[],
    setRequestCanceller?: RequestCanceler
  ): Promise<number> {
  ...
  async updateRequirementDefinition(
    ...
    sortKey: number,
    rowVersion: string,
    updatedFields: FieldsFormInput[],
    newFields: FieldsFormInput[],
    setRequestCanceller?: RequestCanceler
  ): Promise<void> {
   ...
   * Create new action
   */
  async createNewAction(tagId: number, title: string, description: string, dueTimeUtc: Date | null, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Tags/${tagId}/Actions`;
   ...
   * Update action
   */
  async updateAction(tagId: number, actionId: number, title: string, description: string, dueTimeUtc: Date | null, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Tags/${tagId}/Actions/${actionId}`;
   ...
   * Close action
   */
  async closeAction(tagId: number, actionId: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
   ...
   */
  async addAttachmentToAction(tagId: number, actionId: number, file: File, overwriteIfExists: boolean, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Tags/${tagId}/Actions/${actionId}/Attachments`;
   ...
   */
  async deleteAttachmentOnAction(tagId: number, actionId: number, attachmentId: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
   ...
   */
  async getDownloadUrlForActionAttachment(tagId: number, actionId: number, attachmentId: number, setRequestCanceller?: RequestCanceler): Promise<string> {
    const endpoint = `/Tags/${tagId}/Actions/${actionId}/Attachments/${attachmentId}`;
    const settings: AxiosRequestConfig = {
      params: {
        redirect: false,
   ...
   */
  async addAttachmentToTag(tagId: number, file: File, overwriteIfExists: boolean, setRequestCanceller?: RequestCanceler): Promise<void> {
    const endpoint = `/Tags/${tagId}/Attachments`;
   ...
   */
  async deleteAttachmentOnTag(tagId: number, attachmentId: number, rowVersion: string, setRequestCanceller?: RequestCanceler): Promise<void> {
  ...
  async getModes(includeVoided: boolean, setRequestCanceller?: RequestCanceler): Promise<ModeResponse[]> {
    ...
    try {
      const result = await this.client.get<ModeResponse[]>(endpoint, settings);
      return result.data;
    } catch (error) {
      throw new PreservationApiError(error);
    }
  ...
  async getHistory(tagId: number, setRequestCanceller?: RequestCanceler): Promise<HistoryResponse[]> {
    ...
    try {
      const result = await this.client.get<HistoryResponse[]>(endpoint, settings);
      return result.data;
    } catch (error) {
      throw new PreservationApiError(error);
    }
