...
class PreservationApiClient extends ApiClient {
    ...
    async checkAreaTagNo(
        ...
        this.setupRequestCanceler(settings, setRequestCanceller);
        try {
            const result = await this.client.get<CheckAreaTagNoResponse>(
                endpoint,
                settings
            );
            return result.data;
    ...
    async getSavedTagListFilters(
        projectName: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<SavedScopeFilterResponse[]> {
        ...
        try {
            const result = await this.client.get<SavedScopeFilterResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     */
    async updateSavedTagListFilter(
     ...
     */
    async deleteSavedTagListFilter(
        savedFilterId: number,
        rowVersion: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<void> {
    ...
    async preserveSingleRequirement(
        tagId: number,
        requirementId: number
    ): Promise<void> {
    ...
    async getJourneys(
        ...
        try {
            const result = await this.client.get<JourneyResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     */
    async swapStepsOnJourney(
        journeyId: number,
        stepAId: number,
        stepARowVersion: string,
        stepBId: number,
        stepBRowVersion: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<void> {
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getResponsiblesFilterForProject(
        project: string,
        setRequestCanceller?: RequestCanceler
        ...
        this.setupRequestCanceler(settings, setRequestCanceller);
        try {
            const result = await this.client.get<ResponsibleEntity[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getAreaFilterForProject(
        project: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<AreaFilterEntity[]> {
        ...
        this.setupRequestCanceler(settings, setRequestCanceller);
        try {
            const result = await this.client.get<AreaFilterEntity[]>(
                endpoint,
                settings
            );
            return result.data;
    ...
    async getTagDetails(
        tagId: number,
        setRequestCanceller?: RequestCanceler
    ): Promise<TagDetailsResponse> {
        const endpoint = `/Tags/${tagId}`;
        const settings: AxiosRequestConfig = {};
        this.setupRequestCanceler(settings, setRequestCanceller);

        try {
            const result = await this.client.get<TagDetailsResponse>(
                endpoint,
                settings
            );
            return result.data;
    ...
    async getTagRequirements(
        tagId: number,
        includeVoided = false,
        includeAllUsages = false,
        setRequestCanceller?: RequestCanceler
    ): Promise<TagRequirementsResponse[]> {
        ...
        try {
            const result = await this.client.get<TagRequirementsResponse[]>(
                endpoint,
                settings
            );
            return result.data;
    ...
    async recordTagRequirementValues(
        tagId: number,
        recordValues: TagRequirementRecordValues,
        setRequestCanceller?: RequestCanceler
    ): Promise<void> {
    ...
    async getRequirementTypes(
        includeVoided = false,
        setRequestCanceller?: RequestCanceler
    ): Promise<RequirementTypeResponse[]> {
     ...
     */
    async voidRequirementDefinition(
        requirementTypeId: number,
        requirementDefinitionId: number,
        rowVersion: string,
        setRequestCanceller?: RequestCanceler
     ...
     */
    async unvoidRequirementDefinition(
        requirementTypeId: number,
        requirementDefinitionId: number,
        rowVersion: string,
        setRequestCanceller?: RequestCanceler
     ...
     */
    async deleteRequirementDefinition(
        requirementTypeId: number,
        requirementDefinitionId: number,
        rowVersion: string,
        setRequestCanceller?: RequestCanceler
    ...
    async getActions(
        ...
        try {
            const result = await this.client.get<ActionResponse[]>(
                endpoint,
                settings
            );
            return result.data;
    ...
    async getActionDetails(
        ...
        try {
            const result = await this.client.get<ActionDetailsResponse>(
                endpoint,
                settings
            );
            return result.data;
    ...
    async getActionAttachments(
        ...
        try {
            const result = await this.client.get<AttachmentResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getJourneyFilters(
        projectName: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<JourneyFilterResponse[]> {
        ...
        try {
            const result = await this.client.get<JourneyFilterResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getModeFilters(
        projectName: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<ModeFilterResponse[]> {
        ...
        try {
            const result = await this.client.get<ModeFilterResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getRequirementTypeFilters(
        projectName: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<RequirementTypeFilterResponse[]> {
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getTagFunctionFilters(
        projectName: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<TagFunctionFilterResponse[]> {
        ...
        try {
            const result = await this.client.get<TagFunctionFilterResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     * @param setRequestCanceller Returns a function that can be called to cancel the request
     */
    async getDisciplineFilters(
        projectName: string,
        setRequestCanceller?: RequestCanceler
    ): Promise<DisciplineFilterResponse[]> {
        ...
        try {
            const result = await this.client.get<DisciplineFilterResponse[]>(
                endpoint,
                settings
            );
            return result.data;
     ...
     */
    async getDownloadUrlForTagAttachment(
        tagId: number,
        attachmentId: number,
        setRequestCanceller?: RequestCanceler
    ): Promise<string> {
