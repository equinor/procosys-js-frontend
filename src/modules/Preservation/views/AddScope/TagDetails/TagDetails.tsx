...
const TagDetails = ({ selectedTags, removeTag, collapsed = true, showMCPkg = true }: TagDetailsProps): JSX.Element => {
  ...
  return (
    <div>
      ...
      <TagList>{selectedTags.map((tag) => createTagSection(tag))}</TagList>
    </div>
  );
};
