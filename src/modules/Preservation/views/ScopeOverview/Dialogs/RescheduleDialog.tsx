...
import { FormFieldSpacer, InputContainer, OverflowColumn } from './RescheduleDialog.style';
...
import { ButtonContainer, ButtonSpacer, DialogContainer, Divider, MainContainer, Scrim, TableContainer, Title } from './SharedCode/Dialogs.style';
        ...
        <Content>
          ...
          {reschedulableTags.length > 0 && (
            <InputContainer>
              ...
              <FormFieldSpacer>
                <SelectInput title="direction" onChange={(value): void => setDirectionItem(directionItems.find((p: SelectItem) => p.value === value))} data={directionItems} label={'Direction'}>
