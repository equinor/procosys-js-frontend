...
const CheckboxFilter = ({ title, filterValues = [], tagListFilterParam, itemsChecked, onCheckboxFilterChange, icon }: CheckboxFilterProps): JSX.Element => {
            ...
            return (
              <ScopeFilterCheckbox
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>): void => {
                  onCheckboxFilterChange(tagListFilterParam, String(value.id), e.target.checked);
                }}
                label={value.title}
              ></ScopeFilterCheckbox>
            );
