...
const ActionExpanded = ({ tagId, isVoided, actionId, toggleDetails, getActionList, setDirty }: ActionDetailsProps): JSX.Element => {
    ...
    <Container isClosed={actionDetails.isClosed}>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        <Section>
          ...
          <Typography variant="body_short">{getDateField(actionDetails.dueTimeUtc)}</Typography>
        </Section>
        {!isVoided && !actionDetails.isClosed && (
          <IconContainer>
            <StyledButton data-testid="editIcon" variant="ghost" onClick={(): void => setShowEditMode(true)}>
              {editIcon}
            </StyledButton>
          </IconContainer>
        )}
      ...
      <Section>
        ...
        <ActionAttachments tagId={tagId} isVoided={isVoided} actionId={actionId} enableActions={false} />
      </Section>
