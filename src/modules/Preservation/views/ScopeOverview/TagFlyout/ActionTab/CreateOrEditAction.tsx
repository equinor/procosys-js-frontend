import { AttachmentsContainer, ButtonContainer, ButtonSpacer, Container, DateContainer, Header, InputContainer } from './CreateOrEditAction.style';
...
const CreateOrEditAction = ({ tagId, isVoided, actionId, title, description, dueTimeUtc, rowVersion, backToParentView, setDirty }: ActionTabProps): JSX.Element => {
  ...
  return (
    <Container>
      ...
      <InputContainer>
        <TextField id={'title'} label="Title" inputRef={titleInputRef} placeholder="Write here" onChange={(e: React.ChangeEvent<HTMLInputElement>): void => setNewTitle(e.target.value)} />
      </InputContainer>
      <InputContainer>
        <TextField
          id={'description'}
      ...
      {actionId && (
        <AttachmentsContainer>
          ...
          <ActionAttachments tagId={tagId} isVoided={isVoided} actionId={actionId} enableActions={true} />
        </AttachmentsContainer>
      )}
