...
const PreservationTab = ({ tagDetails, refreshTagDetails, setDirty }: PreservationTabProps): JSX.Element => {
      ...
      <TagDetailsContainer>
        <Details>
          ...
          <div style={{ marginTop: 'calc(var(--grid-unit) * 2)' }}>
            <GridFirstRow>
              <Typography variant="caption" style={{ gridColumn: '1', gridRow: '1' }}>
                Journey
              </Typography>
              <Typography variant="caption" style={{ gridColumn: '2', gridRow: '1' }}>
                Mode
              </Typography>
              <Typography variant="caption" style={{ gridColumn: '3', gridRow: '1' }}>
                Resp.
              </Typography>
              <Typography variant="body_long" style={{ gridColumn: '1', gridRow: '2' }}>
                {tagDetails.journey.title}
              </Typography>
              <Typography variant="body_long" style={{ gridColumn: '2', gridRow: '2' }}>
                {tagDetails.mode.title}
              </Typography>
              <Typography variant="body_long" style={{ gridColumn: '3', gridRow: '2' }}>
          ...
          <div style={{ marginTop: 'var(--grid-unit)' }}>
            <GridSecondRow>
              ...
              <Typography variant="caption" style={{ gridColumn: '4', gridRow: '1' }}>
                Area
              </Typography>
              ...
              <Typography variant="body_short" style={{ gridColumn: '4', gridRow: '2' }}>
                {tagDetails.areaCode}
              </Typography>
            </GridSecondRow>
          </div>
      ...
      <TagDetailsInputContainer>
        <TextFieldContainer>
          {editingRemark ? (
            ...
            <div style={{ width: '100%' }}>
              <TextFieldLabelReadOnly>Remark</TextFieldLabelReadOnly>
              <TextFieldReadOnly data-testid="remarkReadOnly">{remark}</TextFieldReadOnly>
            </div>
          )}
          {tagDetails.isVoided ? (
            <></>
            ...
            <IconContainer>
              <StyledButton data-testid="remarkClearIcon" variant="ghost_icon" onClick={cancelEditRemark}>
                <Clear fontSize="small" />
              </StyledButton>
              <StyledButton data-testid="remarkCheckIcon" variant="ghost_icon" onClick={saveRemark}>
                <Check fontSize="small" />
              </StyledButton>
            </IconContainer>
          ) : (
            <IconContainer>
              <StyledButton data-testid="remarkEditIcon" variant="ghost_icon" onClick={(): void => setEditingRemark(true)}>
        ...
        <TextFieldContainer style={{ width: '55%' }}>
          {editingStorageArea ? (
            <TextField
              ...
              onKeyDown={(e: React.KeyboardEvent<HTMLInputElement>): void => {
                e.keyCode === KEYCODE_ENTER && saveStorageArea();
              }}
            />
          ) : (
            <div style={{ width: '100%' }}>
              <TextFieldLabelReadOnly>Storage area</TextFieldLabelReadOnly>
              <TextFieldReadOnly data-testid="storageAreaReadOnly">{storageArea}</TextFieldReadOnly>
            </div>
          )}
          {tagDetails.isVoided ? (
            <></>
            ...
            <IconContainer>
              <StyledButton data-testid="storageAreaClearIcon" variant="ghost_icon" onClick={cancelEditStorageArea}>
                <Clear fontSize="small" />
              </StyledButton>
              <StyledButton data-testid="storageAreaCheckIcon" variant="ghost_icon" onClick={saveStorageArea}>
                <Check fontSize="small" />
              </StyledButton>
            </IconContainer>
          ) : (
            <IconContainer>
              <StyledButton data-testid="storageAreaEditIcon" variant="ghost_icon" onClick={(): void => setEditingStorageArea(true)}>
                <EditOutlined fontSize="small" />
              </StyledButton>
            </IconContainer>
          )}
