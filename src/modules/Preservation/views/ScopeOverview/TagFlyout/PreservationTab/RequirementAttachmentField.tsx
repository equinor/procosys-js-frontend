...
const RequirementAttachmentField = ({ requirementId, field, tagId, readonly, onAttachmentUpdated }: RequirementAttachmentFieldProps): JSX.Element => {
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      {filename && (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <AttachmentLink onClick={downloadAttachment}>{filename}</AttachmentLink>
          {!readonly && (
      ...
      {!readonly && (
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          <div style={{ marginTop: 'var(--grid-unit)' }}>
            <form>
              <SelectFileButton onClick={handleAddFile}>Select file</SelectFileButton>
              <input id="uploadFile" style={{ display: 'none' }} type="file" ref={inputFileRef} onChange={handleSubmitFile} />
            </form>
          </div>
