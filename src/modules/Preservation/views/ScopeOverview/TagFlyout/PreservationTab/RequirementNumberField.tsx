...
const RequirementNumberField = ({ requirementId, field, readonly, onFieldChange }: RequirementNumberFieldProps): JSX.Element => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'flex-end' }}>
      ...
      {field.showPrevious && (
        ...
        >
          <TextField id={`fieldPrevious${field.id}`} label="Previous value" meta={`(${field.unit})`} defaultValue={previousValue} disabled />
        </div>
      )}
    </div>
  );
