import { Container, LoadingDiv, MCPackageEntry, StyledCard100, StyledTypographyLink, StyledDivider, StyledHeaderTitle, StyledHeaderTitleLink } from './style';
              ...
              <StyledCard100>
                <Card.Header>
                  <StyledHeaderTitleLink className="link-container">
                    ...
                    <StyledTypographyLink variant="body_short" onClick={(): void => navigateToMCPkg(pkg.mcPkg?.mcPkgNo as string)}>
                      {highlightSearchValue(pkg.mcPkg?.mcPkgNo ?? '')}
                      <LinkIndicator>
