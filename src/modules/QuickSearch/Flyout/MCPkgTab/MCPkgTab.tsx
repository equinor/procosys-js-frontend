      ...
      <StyledCard100>
        <Card.Header>
          <StyledHeaderTitleLink className="link-container">
            ...
            <StyledTypographyLink variant="body_short" onClick={(): void => navigateToMCPkg()}>
        ...
        <Card.Header>
          {mcPkg.mcPkg?.commPkgNo ? (
            <StyledHeaderTitleLink className="link-container">
              ...
              <StyledTypographyLink variant="body_short" onClick={(): void => (mcPkg.mcPkg?.commPkgNo ? navigateToCommPkg() : undefined)}>
                {highlightSearchValue(mcPkg.mcPkg?.commPkgNo || '')}
                <LinkIndicator>
                  <EdsIcon name="external_link" />
                </LinkIndicator>
              </StyledTypographyLink>
