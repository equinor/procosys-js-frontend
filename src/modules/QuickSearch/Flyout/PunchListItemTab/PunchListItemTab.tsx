import { Container, LinkIndicator, StyledCard100, StyledCard50, StyledTypographyLink, StyledDivider, StyledHeaderTitle, StyledHeaderTitleLink } from './style';
      ...
      <StyledCard100>
        <Card.Header>
          <StyledHeaderTitleLink className="link-container">
            ...
            <StyledTypographyLink variant="body_short" onClick={(): void => navigateToPunchItem()}>
              {highlightSearchValue(punchItem.punchItem?.punchItemNo ?? '')}
              <LinkIndicator>
          ...
          <Card.Header>
            <StyledHeaderTitleLink className="link-container">
              ...
              <StyledTypographyLink variant="body_short" onClick={(): void => navigateToTag()}>
                {highlightSearchValue(punchItem.punchItem?.tagNo ?? '')}
                <LinkIndicator>
                  <EdsIcon name="external_link" />
                </LinkIndicator>
              </StyledTypographyLink>
