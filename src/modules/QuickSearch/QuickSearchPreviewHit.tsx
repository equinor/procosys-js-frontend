...
const QuickSearchPreviewHit = (props: QuickSearchPreviewHitProps): JSX.Element => {
  ...
  const highlightSearchValue = (text: string): JSX.Element => {
    ...
    return <Highlighter searchWords={props.searchValue.replaceAll('"', '').split(' ')} autoEscape={true} textToHighlight={text} />;
  };
  ...
  return (
    ...
    >
      <SearchResultType>{getTypeIcon(props.item.type ?? '')}</SearchResultType>
